# -*- coding: utf-8 -*-
"""
Created on Tue Feb 17 14:55:53 2026
...
if not parts_k or not machines_k:
    ...
    # Initialize override dict lazily (but do NOT overwrite if it already exists)
    ...
    if show_all_summary:
        ...
        combos_to_show = list(overrides.keys())
